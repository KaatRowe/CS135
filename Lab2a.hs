...
--Help from Adam Case, Bryan Coronado, Khadja, Blake
...
--
-- Hint! where i is take left half and the right half and smush together with new number inbetween
-- Examples:
